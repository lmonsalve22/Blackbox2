...
namespace Login.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //Correo.correoConfirmacion("clentebanks0@gmail.com", "Hola mundo");
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string Nombre)
        {
            if (ModelState.IsValid)
            {
                accesosEntities db = new accesosEntities();
                USER_DETAIL uSER_DETAIL = new USER_DETAIL();
                uSER_DETAIL.id = db.USER_DETAIL.Max(x => x.id) + 1;
                uSER_DETAIL.user = model.Email;
                uSER_DETAIL.fecha = DateTime.Now;
                uSER_DETAIL.aux1 = Nombre;
